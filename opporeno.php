...
$product = [
    'name' => 'Oppo Reno11 5G',
    'price' => 27999,
    'image' => 'reno11.jpg', // Place this image in the "images" folder
    'ram' => '8GB',
    'rom' => '128GB / 256GB',
    'camera' => '50MP (Main, OIS) + 8MP (Ultra-Wide) + 32MP (Telephoto)',
    'battery' => '5000mAh with 67W SuperVOOC Charging',
    'display' => '6.7-inch FHD+ AMOLED, 120Hz',
    'processor' => 'MediaTek Dimensity 7050 (6nm)',
    'os' => 'Android 14, ColorOS 14',
    'description' => 'The Oppo Reno11 5G delivers stunning portrait photography, powerful performance, and a sleek curved AMOLED display. Ideal for style-conscious users who want great cameras and smooth usability.'
];
?>
