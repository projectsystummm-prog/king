...
$product = [
    'name' => 'iPhone SE ',
    'price' => 49900,
    'image' => 'ise.jpg', // Save this image inside your 'images' folder
    'ram' => '4GB',
    'rom' => '64GB / 128GB / 256GB',
    'camera' => '12MP (Wide)',
    'battery' => '2018mAh, Fast Charging + Wireless Charging',
    'display' => '4.7-inch Retina HD LCD',
    'processor' => 'Apple A15 Bionic chip',
    'os' => 'iOS 15 (upgradable)',
    'description' => 'The iPhone SE combines powerful performance with compact design. Featuring the A15 Bionic chip and classic Touch ID, it offers a familiar user experience with strong internals, perfect for users who prefer smaller phones.'
];
?>
