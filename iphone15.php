...
$product = [
    ...
    'price' => 159900,
    'image' => 'i15.jpg', // Save this image inside your 'images' folder
    'ram' => '8GB',
    'rom' => '256GB / 512GB / 1TB',
    'camera' => '48MP (Main) + 12MP (Ultra-Wide) + 12MP (Telephoto, 5x optical zoom)',
    'battery' => '4422mAh (approx), Fast Charging + MagSafe Wireless Charging',
    'display' => '6.7-inch Super Retina XDR OLED, ProMotion 120Hz',
    'processor' => 'Apple A17 Pro chip (3nm)',
    'os' => 'iOS 17',
    'description' => 'The iPhone 15 Pro Max redefines premium performance with the powerful A17 Pro chip, aerospace-grade titanium body, advanced Pro camera system, and a stunning 120Hz OLED display. Ideal for users demanding top-tier design and technology.'
];
?>
